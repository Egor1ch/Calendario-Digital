...
try {
    // Primero, crear una tabla específica para días festivos globales
    ...
    // Limpiar festivos existentes para evitar duplicados
    $conn->exec("DELETE FROM festivos_globales");
    echo "Festivos anteriores eliminados.<br>";
    
    // Array con los días festivos por mes
    $festivos = [
        // Enero
        1 => [
    ...
    // Ahora crear los eventos festivos para todos los usuarios existentes
...
function crearEventosFestivosParaUsuarios($conn) {
    ...
    // Limpiar eventos festivos existentes del año actual para evitar duplicados
...
// Función para añadir festivos a nuevos usuarios (para ser llamada desde el registro)
